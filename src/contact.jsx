...
const Contact = () => {
  ...
  return (
    <div id="contact" className="py-20  mx-auto 2xl:w-[500px] xl:w-[500px] lg:w-[500px] sm:w-[400px] xs:w-[300px]">
      ...
      <div className="2xl:w-[500px] xl:w-[500px] lg:w-[500px] sm:w-[400px] xs:w-[300px]">
